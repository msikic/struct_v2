                ...
                for (l = j + 1; l < NY -1 ; ++l) {
                    ...
                    for (m = k + 1; m < NX; ++m) {
                        ...
                        for (n = l + 1; n < NY; ++n) {
                           ...
                           // gettimeofday(&t2, 0);
                            //e1 += (t2.tv_sec-t1.tv_sec) * 1000000 + t2.tv_usec - t1.tv_usec;
                            /* are distances comparable? */
                            
                            //gettimeofday(&t3, 0);
                            if (distance_of_nearest_approach(X_rep, x_triple,
                                    Y_rep, y_triple, 3, &rmsd)) continue;
                            //gettimeofday(&t4, 0);
                            //e2 += (t4.tv_sec-t3.tv_sec) * 1000000 + t4.tv_usec - t3.tv_usec;
                            ...
                            //gettimeofday(&t6, 0);
                            //e3 += (t6.tv_sec-t5.tv_sec) * 1000000 + t6.tv_usec - t5.tv_usec;
                            ...
                            //gettimeofday(&t8, 0);
                            //e4 += (t8.tv_sec-t7.tv_sec) * 1000000 + t8.tv_usec - t7.tv_usec;
                        }
                    }
                }
            }
